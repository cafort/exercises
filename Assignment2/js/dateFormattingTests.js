...
for (var i = 0, i2 = 0; i < dateFormatterMethods.length; i++, i2 += 3) {
    console.log(
        testDate(sampleDates[0], expectedResults[i2], dateFormatterMethods[i])
    );
    console.log(
        testDate(sampleDates[1], expectedResults[i2 + 1], dateFormatterMethods[i])
    );
    console.log(
        testDate(sampleDates[2], expectedResults[i2 + 2], dateFormatterMethods[i])
    );
}